const USE_DARKRED_BALL = 'USE_DARKRED_BALL';
const USE_BLACK_HOLE = 'USE_BLACK_HOLE';
const USE_CLASSIC_DIAMOND = 'USE_CLASSIC_DIAMOND';
const USE_EMERALD = 'USE_EMERALD';

export { USE_DARKRED_BALL, USE_BLACK_HOLE, USE_CLASSIC_DIAMOND, USE_EMERALD };
